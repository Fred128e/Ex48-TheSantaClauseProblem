...
namespace Ex48_TheSantaClauseProblem
{
    class Program
    {
        ...
        static SemaphoreSlim _semRensdyr = new SemaphoreSlim(9);
        ...
        {
            Console.WriteLine(id + " vil gerne ind i stalden.");
            _semRensdyr.Wait();
            Console.WriteLine(id + " er ankommet i stalden.");
            Thread.Sleep(2000);
            _semRensdyr.Release();
            Console.WriteLine(id + " har forladt stalden.");
            Console.ReadKey();
        }
